package random.andre.radixSort;

import algorithms.sorting.radixSort.RadixSort;

/**
 * Custom Test class for radixSort. To be phased out to JUnit tests.
 */
public class Test {
    /**
     * Helper method to print int elements in an array.
     *
    ...
    public static void main(String[] args) {
        int[] test1 =
            new int[] {
                2, 3, 4, 1, 2, 5, 6, 7, 10, 15, 20, 13, 1, 2, 15, 12, 20, 21, 12, 11, 5, 7, 23,
                30
            };
        ...
        int[] test4 =
            new int[] {
                1 << 25 + 123, 1 << 28 + 340230, 34954043, 5678, 987654, 121234, 1, 0, 20493943,
                1 << 20 + 543298
            };
