 ...
 * [1, 0, 0]]
 * <p>
 * Adjacency list in the form of an array of lists: ArrayList[] , where array[i] is a list of neighbour indexes
 ...
 * <p>
 * While a list implementation is used here, the conventional implementation of adjacency lists utilizes linked
 * lists or nodes
...
public class MatrixToListConverter {
    ...
    /**
     * Converts a given adjacency matrix to an adjacency list.
     *
     * @param adjM the adjacency matrix to be converted.
     * @return the adjacency list representation of the adjacency matrix.
     *
     * @throws InvalidMatrixException if an error occurs while converting the matrix.
     */
    public static List<Integer>[] convert(int[][] adjM) throws InvalidMatrixException {
        ...
        if (Arrays.equals(adjM, new int[0][0])) {
    ...
    /**
     * Custom Exception representing an invalid matrix.
     */
